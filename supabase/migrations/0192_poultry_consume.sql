...
--
-- ⚠ **0193 تخلف هذه الدالّة** بتوقيعٍ أوسعَ (فترةُ السحب). فلا تُنزَّل 0192
--   وحدَها بعد 0193: القديمةُ ستعود حيّةً بجانب الجديدة، ويرى PostgREST
--   توقيعَين فيردّ PGRST203 على **كلّ** صرفٍ من الواجهة. تُنزَّل الموجةُ
--   بترتيبها دائماً — وفحصُ «توقيعٌ واحدٌ بالقاعدة» بالحزمة يمسك الخلاف.
--
