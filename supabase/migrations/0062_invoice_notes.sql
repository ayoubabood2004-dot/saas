-- ============================================================================
-- doctorVet — 0062: invoice notes (ملاحظات الطبيب على الفاتورة).
--
-- A free-text note the doctor/cashier attaches at checkout. It shows in the
-- pet's record (sales history) and on the printed invoice.
--
-- retail_checkout is re-defined on top of 0036 (fractional sales, split
-- payments, credit/amount_paid and the final-price override all preserved) to
-- persist p_meta.notes. Additive & idempotent. Apply AFTER 0036.
-- ============================================================================
