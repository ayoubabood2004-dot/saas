-- ============================================================================
-- ٠١٥٣ — الكتالوجُ المشترك يعطي ولا يكشف
--
...
-- عرضٍ ومنحٍ فقط. إضافيةٌ وتُعاد بلا أثرٍ ثانٍ. تُطبَّق بعد 0152.
-- ============================================================================
...
comment on column clinic_prefs.catalog_share is
  'مشاركةُ أسعار هذه العيادة بالكتالوج المشترك. يبدّله المديرُ وحده (0153) — قرارٌ تجاريّ لا تفضيلُ واجهة.';
