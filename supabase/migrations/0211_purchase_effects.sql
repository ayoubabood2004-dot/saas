...
--    وحدٌّ صريح: سطرٌ **ثانٍ** لنفس المادّة بالتعديل «كان» فيه ما تركه الأوّل، وقد
--    يكون سالباً وسطياً (٥٠ اشتُريت، ٤٥ بيعت، والتعديلُ ١٠+٣٠ ⇒ الثاني يرى −٣٥).
--    فالقارئُ يجمع بالمادّة: أوّلُ «كان» وآخرُ «صار» (وهو الحالُ النهائية دائماً)،
--    و`qty` بالتعديل كميةُ السطر لا الفرق — الفرقُ من «كان» و«صار».
--
