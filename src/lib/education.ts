...
export const EDUCATION: EduItem[] = [
  {
    ...
    body: {
      ...
      ar: [
        ...
        "اتصل بالعيادة إذا امتنع عن الأكل أكثر من ٢٤ ساعة أو انفتح الجرح.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    summary: { en: "What to expect in the first 16 weeks and beyond.", ar: "ما الذي تتوقّعه في أول ١٦ أسبوعاً وما بعدها." },
    body: {
      en: [
      ...
      ar: [
        "تبدأ التطعيمات الأساسية عادةً في ٦–٨ أسابيع وتتكرّر كل ٣–٤ أسابيع حتى ١٦ أسبوعاً.",
        "يُعطى السعار مرة واحدة حوالي ١٢–١٦ أسبوعاً ثم جرعة داعمة وفق القانون المحلي.",
