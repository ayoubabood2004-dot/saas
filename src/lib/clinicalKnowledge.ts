...
export const SYMPTOMS: Symptom[] = [
  ...
  // ── Expanded corpus — comprehensive clinical signs across every system ──────
  // General / systemic
  { id: "hypothermia", label: "انخفاض حرارة الجسم", emoji: "❄️" },
  { id: "weakness", label: "ضعف عام ووهن", emoji: "😪" },
  { id: "collapse", label: "انهيار أو إغماء مفاجئ", emoji: "😵" },
  { id: "pale_mucous", label: "شحوب الأغشية المخاطية", emoji: "🫥" },
  { id: "weight_gain", label: "زيادة الوزن", emoji: "⚖️" },
  { id: "polyphagia", label: "شراهة الأكل", emoji: "🍽️" },
  { id: "lymphadenopathy", label: "تضخّم العقد اللمفاوية", emoji: "🫧" },
  { id: "edema", label: "وذمة واحتباس سوائل", emoji: "💧" },
  // Digestive
  { id: "regurgitation", label: "قلس (ارتجاع طعام غير مهضوم)", emoji: "↩️" },
  { id: "nausea", label: "غثيان ولعاب زائد", emoji: "🤢" },
  { id: "hematemesis", label: "قيء دموي", emoji: "🩸" },
  { id: "melena", label: "براز أسود (ميلينا)", emoji: "⚫" },
  { id: "tenesmus", label: "زحير (إجهاد عند التبرّز)", emoji: "💢" },
  { id: "dysphagia", label: "صعوبة البلع", emoji: "😣" },
  { id: "abdominal_pain", label: "ألم بطني", emoji: "💢" },
  { id: "ascites", label: "استسقاء بطني (تجمّع سوائل)", emoji: "🫄" },
  { id: "pica", label: "أكل أشياء غير غذائية (بيكا)", emoji: "🪨" },
  { id: "flatulence", label: "انتفاخ وغازات", emoji: "💨" },
  // Respiratory
  { id: "tachypnea", label: "تسارع التنفّس", emoji: "🌬️" },
  { id: "open_mouth_breathing", label: "تنفّس بالفم المفتوح", emoji: "😮‍💨" },
  { id: "wheezing", label: "أزيز وصفير تنفّسي", emoji: "🎐" },
  { id: "stertor", label: "شخير تنفّسي", emoji: "😴" },
  { id: "epistaxis", label: "رعاف (نزيف من الأنف)", emoji: "🩸" },
  { id: "exercise_intolerance", label: "عدم تحمّل المجهود", emoji: "🥵" },
  // Cardiovascular
  { id: "heart_murmur", label: "لغط قلبي (نفخة)", emoji: "🫀" },
  { id: "arrhythmia", label: "اضطراب نظم القلب", emoji: "📈" },
  { id: "syncope", label: "إغماء (فقدان وعي مؤقت)", emoji: "😵‍💫" },
  { id: "cyanosis", label: "ازرقاق اللثة (نقص أكسجين)", emoji: "🔵" },
  { id: "weak_pulse", label: "نبض ضعيف", emoji: "💓" },
  // Skin & coat
  { id: "erythema", label: "احمرار الجلد", emoji: "🔴" },
  { id: "scaling", label: "قشور وتقشّر الجلد", emoji: "🧂" },
  { id: "crusting", label: "قشور متيبّسة", emoji: "🟤" },
  { id: "pustules", label: "بثور ودمامل قيحية", emoji: "🔴" },
  { id: "pyoderma", label: "التهاب جلدي قيحي", emoji: "🦠" },
  { id: "wound", label: "جرح أو تقرّح جلدي", emoji: "🩹" },
  { id: "ectoparasites", label: "طفيليات خارجية (براغيث/قراد)", emoji: "🐛" },
  { id: "skin_odor", label: "رائحة جلدية كريهة", emoji: "👃" },
  { id: "hyperpigmentation", label: "اسوداد وفرط تصبّغ الجلد", emoji: "⬛" },
  // Urinary
  { id: "pollakiuria", label: "تبوّل متكرر بكميات قليلة", emoji: "🔁" },
  { id: "stranguria", label: "عُسر التبوّل وتقطّره المؤلم", emoji: "💢" },
  { id: "urinary_incontinence", label: "سلس البول (تبوّل لا إرادي)", emoji: "💧" },
  { id: "oliguria", label: "قلّة أو انقطاع البول", emoji: "🚱" },
  { id: "inappropriate_urination", label: "تبوّل بأماكن غير معتادة", emoji: "🚽" },
  // Reproductive
  { id: "vaginal_discharge", label: "إفراز مهبلي أو رحمي", emoji: "🩸" },
  { id: "preputial_discharge", label: "إفراز قضيبي أو غلفي", emoji: "💧" },
  { id: "mammary_mass", label: "كتلة أو تورّم بالضرع", emoji: "🎗️" },
  { id: "testicular_swelling", label: "تورّم الخصية", emoji: "🔴" },
  { id: "dystocia", label: "عُسر الولادة", emoji: "🐣" },
  { id: "infertility", label: "عقم وتعذّر الحمل", emoji: "🚫" },
  { id: "abortion", label: "إجهاض أو موت أجنّة", emoji: "⚠️" },
  // Musculoskeletal
  { id: "stiffness", label: "تيبّس وتصلّب المفاصل", emoji: "🦿" },
  { id: "joint_swelling", label: "تورّم مفصلي", emoji: "🦴" },
  { id: "reluctance_to_move", label: "إحجام عن الحركة", emoji: "🛑" },
  { id: "muscle_atrophy", label: "ضمور عضلي", emoji: "📉" },
  { id: "fracture", label: "كسر أو إصابة عظمية", emoji: "🦴" },
  // Eyes / ears / mouth
  { id: "blepharospasm", label: "تشنّج وإغلاق الجفن", emoji: "😑" },
  { id: "epiphora", label: "زيادة الدمع (دماع)", emoji: "💧" },
  { id: "corneal_opacity", label: "عتامة القرنية", emoji: "☁️" },
  { id: "blindness", label: "ضعف أو فقدان البصر", emoji: "🚫" },
  { id: "third_eyelid", label: "بروز الجفن الثالث", emoji: "👁️" },
  { id: "anisocoria", label: "اختلاف حجم الحدقتين", emoji: "👀" },
  { id: "head_shaking", label: "هزّ الرأس وحكّ الأذن", emoji: "🙉" },
  { id: "aural_hematoma", label: "ورم دموي بصيوان الأذن", emoji: "🩸" },
  { id: "otitis_externa", label: "التهاب الأذن الخارجية", emoji: "👂" },
  { id: "gingivitis", label: "التهاب اللثة", emoji: "🦷" },
  { id: "dental_tartar", label: "جير الأسنان", emoji: "🦷" },
  { id: "oral_ulcer", label: "تقرّحات الفم", emoji: "👄" },
  { id: "oral_mass", label: "كتلة داخل الفم", emoji: "👄" },
  // Neurological & behavioural
  { id: "paralysis", label: "شلل", emoji: "🦽" },
  { id: "paresis", label: "خزل (ضعف حركي جزئي)", emoji: "🦵" },
  { id: "circling", label: "الدوران بدائرة", emoji: "🔄" },
  { id: "disorientation", label: "تشوّش وفقدان اتجاه", emoji: "🌀" },
  { id: "nystagmus", label: "رأرأة العين", emoji: "👀" },
  { id: "head_pressing", label: "ضغط الرأس على الجدران", emoji: "🧱" },
  { id: "behavioral_change", label: "تغيّر مفاجئ بالسلوك", emoji: "🔀" },
  { id: "hyperesthesia", label: "فرط حساسية اللمس والألم", emoji: "⚡" },
  { id: "vocalization", label: "أنين وأصوات ألم", emoji: "🔊" },
];
...
export const SYMPTOM_CATEGORIES: SymptomCategory[] = [
  { id: "general", name: "الحالة العامة", systemId: "general", symptomIds: ["fever", "hypothermia", "lethargy", "weakness", "collapse", "anorexia", "polyphagia", "weight_loss", "weight_gain", "dehydration", "pale_mucous", "lymphadenopathy", "edema"] },
  { id: "digestive", name: "الجهاز الهضمي", systemId: "digestive", symptomIds: ["vomiting", "hematemesis", "regurgitation", "nausea", "diarrhea", "bloody_stool", "melena", "constipation", "tenesmus", "abdominal_distension", "abdominal_pain", "ascites", "dysphagia", "flatulence", "pica", "jaundice"] },
  { id: "respiratory", name: "التنفّس والأنف", systemId: "respiratory", symptomIds: ["dyspnea", "tachypnea", "open_mouth_breathing", "cough", "wheezing", "stertor", "sneezing", "nasal_discharge", "epistaxis", "exercise_intolerance"] },
  { id: "cardio", name: "القلب والدورة الدموية", systemId: "cardio", symptomIds: ["heart_murmur", "arrhythmia", "syncope", "cyanosis", "weak_pulse"] },
  { id: "derm", name: "الجلد والفراء", systemId: "derm", symptomIds: ["pruritus", "hair_loss", "erythema", "scaling", "crusting", "pustules", "pyoderma", "wound", "skin_lesion", "ectoparasites", "skin_odor", "hyperpigmentation", "mass"] },
