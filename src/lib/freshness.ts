...
/** ط٥ (قرار المالك): التابُ الظاهرُ يُسأل كلَّ هذا — كاشيرٌ يحدّق بنفس الشاشة ساعةً لا
 *  «يرجع» إليها، والمديرُ رصّد من جهازه. بنفس قرار العودة: لا بيعة، ولا جلبان، ولا مخفيّ. */
