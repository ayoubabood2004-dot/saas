...
export function Inventory() {
  ...
  useEffect(() => {
    if (restricted && (view === "purchases" || view === "ledger" || view === "wholesale")) setView("products");
  }, [restricted, view]);
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      ...
      <div className="mb-4 inline-flex flex-wrap rounded-2xl bg-surface-2 p-1">
        ...
        {!restricted && canPos && <ViewTab active={view === "wholesale"} icon={Layers} label={t("pos.tabWholesale", "البيع بالجملة")} onClick={() => { playTap(); setView("wholesale"); }} />}
