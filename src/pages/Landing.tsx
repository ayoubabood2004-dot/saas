 ...
 *
 * ── اللغة ─────────────────────────────────────────────────────────────────
 * الصفحة **مترجَمة بالكامل**، والافتراضي صار العربية تبعاً لافتراض التطبيق:
 * سوقُنا المقيس عراقيّ، ومبدّل اللغة بالأعلى يخدم الزائرَ الأجنبيّ من أوّل
 * شاشة (واختيارُه يُحفظ فلا يُسأل مرّتين). والاتجاه يُشتقّ
